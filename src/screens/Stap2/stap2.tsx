  ...
  return (
    <View style = {{ justifyContent:'center',alignItems:'center',}}>
      ...
      <View style = {{ justifyContent:'center',alignItems:'center',flex:1,marginTop:90}}>
        ...
        source={require('./../../../src/assate/stap-2.png')}
/>
    </View>
    {/* img top coding end */}
    ...
    <View style = {{ justifyContent:'center',alignItems:'center', marginTop:20, flex:1}}>
      <Text style={{fontSize:30, fontWeight:'700'}}>Customize your high-end travel</Text>
      <Text style={{fontSize:20, fontWeight:'700',color:'gray', marginTop:0,marginBottom:10}}>Countless high-end enteraniment facilities</Text>
      <View style={{flex:2}}>
      <Image
